...
description: |
  In this blog, I'll be referring to soccer as football -- since it's played with a foot. 
author:
...
The data was scraped using python and is attached to this blog. I extracted data from the year 2018-2021 which is 4 years and 8 transfer windows. I removed the free and loan transfers because they don't show a transaction between the club.
